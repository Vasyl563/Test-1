  ...
  <div class="px-40">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
      <a
        ...
        :href="`/meal/${encodeURIComponent(ingredient.strIngredient)}`"
...
function searchIngredients() {
  if (!searchQuery.value) {
    // If searchQuery is empty, show all ingredients
    meals.value = [];
    return;
  }
...
<style>
.input-focus:focus {
  outline: none; /* Забираємо стандартний стиль обводки */
  box-shadow: 0 0 0 3px rgba(239, 68, 68, 0.5); /* Обводка (ring) коліром orange-500 */
